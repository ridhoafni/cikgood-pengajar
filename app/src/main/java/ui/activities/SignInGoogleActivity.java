...
public class SignInGoogleActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void init() {
        ...
        dialog = new ProgressDialog(SignInGoogleActivity.this);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    Log.d("LoginActivity2", "onAuthStateChanged:signed_in:" + user.getUid());
                } else {
                    // User is signed out
                    Log.d("LoginActivity2", "onAuthStateChanged:signed_out");
                }
                // [START_EXCLUDE]
                updateUI(user);
                // [END_EXCLUDE]
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(SignInGoogleActivity.this /* FragmentActivity */,  this /* OnConnectionFailedListener */)
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_google:
                if (boolean_google){
                    ...
                    Glide.with(SignInGoogleActivity.this).load(R.drawable.user).into(iv_image);
                }else {
                    signIn();
                }
                break;
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        Log.d("LoginActivity2", "firebaseAuthWithGoogle:" + acct.getId());
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d("LoginActivity2", "signInWithCredential:onComplete:" + task.isSuccessful());

                        // If sign in fails, display a message to the user. If sign in succeeds
                        // the auth state listener will be notified and logic to handle the
                        // signed in user can be handled in the listener.
                        if (!task.isSuccessful()) {
                            Log.w("LoginActivity2", "signInWithCredential", task.getException());
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Glide.with(SignInGoogleActivity.this).load( user.getPhotoUrl()).into(iv_image);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        // be available.
        Log.d("LoginActivity2", "onConnectionFailed:" + connectionResult);
